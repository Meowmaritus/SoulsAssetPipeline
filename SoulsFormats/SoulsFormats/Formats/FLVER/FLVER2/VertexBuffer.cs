...
namespace SoulsFormats
{
    public partial class FLVER2
    {
        ...
        public class VertexBuffer
        {
            ...
            public int LLA_BufferIndex;
            public int LLA_VertexCount;
            public int LLA_VertexSize;
            public byte[] LLA_BufferData;
            ...
            internal VertexBuffer(BinaryReaderEx br)
            {
                ...
                LLA_BufferIndex = BufferIndex;
                LLA_VertexCount = VertexCount;
                LLA_VertexSize = VertexSize;
                LLA_BufferData = br.GetBytes(BufferOffset, VertexSize * VertexCount);
            }
