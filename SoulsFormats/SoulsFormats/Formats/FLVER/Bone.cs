...
namespace SoulsFormats
{
    public partial class FLVER
    {
        ...
        public class Bone
        {
            ...
            /// <summary>
            /// Unknown alternate name string for some Bluepoint struct in DESR
            /// </summary>
            public string BluepointName { get; set; }
            ...
            internal Bone(BinaryReaderEx br, bool unicode)
            {
                ...
                {
                    br.AssertInt32(0);
                    long desrNameOffset = br.ReadInt64();
                    long desrBluepointNameOffset = br.ReadInt64();
                    if (unicode)
                        Name = br.GetUTF16(desrNameOffset);
                    else
                        Name = br.GetShiftJIS(desrNameOffset);
                    BluepointName = br.GetASCII(desrBluepointNameOffset);
