...
namespace SoulsFormats
{
    ...
    public class FMG : SoulsFile<FMG>
    {
        ...
        /// <summary>
        /// Unused flag that Bluepoint used to indicate that they'd changed the file format for Demon's Souls Remastered (PS5).
        /// </summary>
        public bool IsDESR;
        ...
        protected override void Read(BinaryReaderEx br)
        {
            ...
            br.AssertByte(1);
            br.AssertByte((byte)((Version == FMGVersion.DemonsSouls && !IsDESR) ? 0xFF : 0x00));
            br.AssertByte(0);
            br.AssertByte(0);
        ...
        protected override void Write(BinaryWriterEx bw)
        {
            ...
            bw.WriteByte(1);
            bw.WriteByte((byte)((Version == FMGVersion.DemonsSouls && !IsDESR) ? 0xFF : 0x00));
            bw.WriteByte(0);
            bw.WriteByte(0);
