...
namespace SoulsFormats
{
    ...
    {
        public static Action LoadOodleAction = null;
        ...
        private static byte[] DecompressDCXDFLT(BinaryReaderEx br, Type type)
        {
            ...
            //Original
            //br.AssertInt32(0x0);
            //Modification for Elden Ring
            br.AssertInt32(0x0, 0xF000000);
        ...
        private static byte[] DecompressDCXKRAK(BinaryReaderEx br)
        {
            ...
            try
            {
                res = Oodle26.Decompress(compressed, uncompressedSize);
            }
            catch (DllNotFoundException)
            {
                LoadOodleAction?.Invoke();
            }
            res = res ?? Oodle26.Decompress(compressed, uncompressedSize);
            return res;
        }
