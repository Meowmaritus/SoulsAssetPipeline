...
#pragma warning disable CS1591
        ...
        public class HKArray<T> : IHKXSerializable where T : IHKXSerializable, new()
        {
            ...
            private HKArrayData<T> MemeFakeArrayData;
            ...
            {
                MemeFakeArrayData = memeFakeArrayData;
                Size = (uint)memeFakeArrayData.Elements.Count;
            }
        ...
        public class HKCString : IHKXSerializable
        {
            ...
            private string FakeMemeData;

            public HKCString(string data)
            {
                FakeMemeData = data;
            }
